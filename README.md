...
7 of the 9 domain skills above are shipped; the remaining 2 (`streaming-data-engineering`, `iac-cloud-data-engineering`) ship incrementally — see `docs/` for the design specs.
