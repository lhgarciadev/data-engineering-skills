...
**Estado (2026-07-30):** 4 de 8 skills de dominio entregadas (`python-data-engineering`, `sql-data-engineering`, `spark-data-engineering`, `pipelines-architecture-data-engineering`), más la orquestadora `data-engineering`. Quedan 4 skills de dominio por construir: `modeling-data-engineering`, `streaming-data-engineering`, `quality-data-engineering`, `iac-cloud-data-engineering` (ver sección 7, ítem 6, actualizado).
