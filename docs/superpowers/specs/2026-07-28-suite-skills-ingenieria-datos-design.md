...
**Estado (2026-08-02):** 4 de 8 skills de dominio del roadmap original entregadas (`python-data-engineering`, `sql-data-engineering`, `spark-data-engineering`, `pipelines-architecture-data-engineering`), más la orquestadora `data-engineering` y, fuera de ese roadmap original de 8, una novena skill entregada el 2026-08-02: `project-structure-data-engineering` (estructura de paquete, empaquetado y contratos de datos — ver `docs/superpowers/specs/2026-08-02-project-structure-skill-design.md`). Quedan 4 skills de dominio del roadmap original por construir: `modeling-data-engineering`, `streaming-data-engineering`, `quality-data-engineering`, `iac-cloud-data-engineering` (ver sección 7, ítem 6, actualizado).
...
## 4. Las 8 skills de dominio del roadmap original — propósito de cada una
...
- **Qué hace al activarse**:
  1. Identifica cuáles de las 8 skills de dominio del roadmap original aplican a la tarea (más `project-structure-data-engineering`, entregada fuera de ese roadmap — ver Estado arriba).
...
6. Por cada una de las 4 skills de dominio restantes (`modeling-data-engineering`, `streaming-data-engineering`, `quality-data-engineering`, `iac-cloud-data-engineering` — `sql-data-engineering` y `spark-data-engineering` ya se entregaron 2026-07-29, y `pipelines-architecture-data-engineering` se entregó 2026-07-30, ver `docs/superpowers/specs/2026-07-28-sql-skill-design.md`, `docs/superpowers/specs/2026-07-29-spark-skill-design.md` y `docs/superpowers/specs/2026-07-30-pipelines-architecture-skill-design.md`): el usuario aporta tópicos → investigación web complementaria → redacción → validación de discoverability liviana (mismo proceso que `python-data-engineering` y `sql-data-engineering`).
...
- Contenido detallado (reference files) de las skills de dominio pendientes — se define skill por skill en la fase siguiente. Eran 7 al escribir esta spec (2026-07-28); `sql-data-engineering`, `spark-data-engineering` y `pipelines-architecture-data-engineering` ya se entregaron desde entonces, quedan 4 (ver Estado arriba y §7 ítem 6).
